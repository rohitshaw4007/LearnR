...
export async function POST(request) {
  try {
    ...
    const mailOptions = {
      ...
      to: user.email,
      subject: "Password Change OTP - LearnR",
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; border: 1px solid #eee;">
          <h2 style="color: #ef4444;">LearnR Password Reset</h2>
          <p>Hello <strong>${user.name}</strong>,</p>
          <p>You requested to change your password. Your OTP is:</p>
          <h1 style="background: #fef2f2; padding: 10px; text-align: center; letter-spacing: 5px; color: #ef4444;">${generatedOtp}</h1>
